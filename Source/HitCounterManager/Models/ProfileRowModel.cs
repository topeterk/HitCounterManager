...
namespace HitCounterManager.Models
{
    public  class ProfileRowModel(ProfileRow origin, ProfileModel parent) : NotifyPropertyChangedImpl
    {
        ...
        {
            get => _origin.Hits;
            set { if (SetAndNotifyWhenNaturalNumberChanged(ref _origin.Hits, value)) RaisePropertyChanged(nameof(Diff)); }
        }
        public int WayHits
        {
            get => _origin.WayHits;
            set { if (SetAndNotifyWhenNaturalNumberChanged(ref _origin.WayHits, value)) RaisePropertyChanged(nameof(Diff)); }
        }
        ...
        {
            get => _origin.PB;
            set { if (SetAndNotifyWhenNaturalNumberChanged(ref _origin.PB, value)) RaisePropertyChanged(nameof(Diff)); }
        }
        ...
        public void SPChanged() => RaisePropertyChanged(nameof(SP));
        public bool BP => this == _parent.BestProgressModel;
        public void BPChanged() => RaisePropertyChanged(nameof(BP));
        ...
        public void ActiveChanged() => RaisePropertyChanged(nameof(Active));
    }
}
