...
namespace LiveSplit.UI.Components
{
    public class ASLComponent : LogicComponent
    {
        ...
        public bool CheckPathScript()
        {
            return (_settings.ScriptPath != _old_script_path || _do_reload);
        }
        ...
        {
            return _settings.ObjectChecked;
        }

        public void SetCheckStatus(bool status)
        {
             _settings.ObjectChecked = status;
        }
