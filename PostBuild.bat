...
FOR %%G IN (img_check.png img_cross.png HitCounter.html HitCounter.template HitCounterNoDeath.html HitCounterNumeric.html HitCounterYesNo.html) DO copy %DIR_SRC%\%%G %DIR_DEST%
